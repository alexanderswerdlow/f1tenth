                             ...
                             lookahead_frame_id_("lookahead")
{
  ...
  sub_path_ = nh_.subscribe("move_base/TebLocalPlannerROS/local_plan", 1, &PurePursuit::receivePath, this);
  sub_odom_ = nh_.subscribe("odometry/filtered", 1, &PurePursuit::computeVelocities, this);
  pub_vel_ = nh_.advertise<geometry_msgs::Twist>("cmd_vel_control", 1);
  pub_acker_ = nh_.advertise<ackermann_msgs::AckermannDriveStamped>("cmd_acker_control", 1);
